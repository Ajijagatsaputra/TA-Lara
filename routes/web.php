...
Route::get('/listmahasiswa', function () {
    return view('admin.master-data.table-mahasiswa');
});
Route::get('/data-dosen', function () {
    return view('admin.master-data.table-dosen');
});
Route::get('/data-alumni', function () {
    return view('admin.master-data.table-alumni');
});
Route::get('/krs', function () {
    return view('admin.perwalian.persetujuan-krs');
});
Route::get('/kelas-perwalian', function () {
    return view('admin.perwalian.kelas-perwalian');
});