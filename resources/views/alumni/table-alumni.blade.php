            ...
            <div class="block block-rounded shadow-sm">
                <div class="block-content block-content-full">
                    ...
                    <div class="table-responsive">
                        <table id="tabel-alumni" class="table table-bordered table-hover align-middle">
    ...
    function initDataTable(tahun) {
        ...
        table = $('#tabel-alumni').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'tahun_lulus',
                    render: d => d ?? '<span class="text-muted fst-italic">Belum tersedia</span>'
                },
                {
                ...
                },
                {
                    data: 'no_hp',
                    className: 'd-none d-sm-table-cell',
                    render: d => d ?? '<span class="text-muted fst-italic">Kosong</span>'
                },
                {
                    data: null,
