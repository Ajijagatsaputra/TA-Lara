                                        ...
                                        <td class="text-center">
                                            <div class="dropdown position-static">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="{{ route('listtracerpengguna.show', $item->id) }}" class="dropdown-item">
                                                            <i class="fa fa-eye me-1"></i> Detail
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('listtracerpengguna.edit', $item->id) }}" class="dropdown-item">
                                                            <i class="fa fa-pencil-alt me-1"></i> Edit
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('listtracerpengguna.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus data?')">
                                                            @csrf
                                                            @method('DELETE')
