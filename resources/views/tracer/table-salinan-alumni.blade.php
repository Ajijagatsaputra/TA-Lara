    ...
    <div class="block block-rounded shadow">
        ...
        <div class="block-content block-content-full">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover align-middle text-center" id="datatable">
    ...
    $(document).ready(function() {
        ...
        const table = $('#datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'tanggal_isi', render: data => data ? new Date(data).toLocaleDateString('id-ID') : '' },
                ...
                { data: 'updated_at' },
                {
                    ...
                    render: function(data) {
                        ...
                        // Hanya tampilkan tombol hapus jika role admin
                        if (userRole === 'admin') {
                            html += `
        ...
        // Tombol hapus: dicegah untuk superadmin
        $('#datatable').on('click', '.btn-delete', function () {
            const userRole = $('meta[name="user-role"]').attr('content');

            if (userRole === 'superadmin') {
                Swal.fire('Akses Ditolak', 'Superadmin tidak diperbolehkan menghapus data.', 'warning');
                return;
            }
